...
def create_projection_matrix(m, d, seed=0, scaling=0, struct_mode=False, projection_type = "Gaussian"):
  ...
  if projection_type == "Hadamard":
    print("Hadamard")
    return(util.Orthogonal_Hadamard(m,d))
  else:
    print("Gaussian")
...
class Attention(tf.keras.layers.Layer):
  ...
  def __init__(self,
    ...
    Args:
      ...
      projection_type: Type of orthogonal projection matrix: {Gaussian, Hadamard} - Gaussian by default
    """
  ...
  def call(self,
    ...
    if self.projection_matrix_type is None:
      ...
      projection_matrix = create_projection_matrix(
          self.nb_random_features, dim, seed=seed,projection_type = self.projection_type)
